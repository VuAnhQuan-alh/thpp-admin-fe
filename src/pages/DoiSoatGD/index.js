...
import { apiExportTransactionControl } from '../../constrains/apiURL';
...
const DoiSoatGD = () => {
  ...
  React.useEffect(() => {
    if (trans !== null) {
      apiSearch(checkKeyNull({ txnRef: trans, page: 1, size: 10 })).then(
        (res) => {
  ...
  return (
    <React.Fragment>
      <div
        ...
        style={{ maxWidth: '1440px', margin: '10px auto' }}
      >
        <ToastContainer />
        <Row>
                  ...
                  <Form>
                    ...
                    <div className="d-flex justify-content-end align-items-center mt-3">
                      ...
                      <Button
                        ...
                        style={{ marginRight: '20px' }}
                        onClick={() => {
                          const paramExport = checkKeyNull({
                            ...params,
                            export: 'PAGE',
                          });
                          const url = `${apiExportTransactionControl}${convertParamsToQuery(
                            {
                              page: pageSize.page,
                              size: pageSize.size,
                            }
                          ...
                          if (
                            paramExport?.endDate === undefined ||
                            paramExport?.startDate === undefined
                          ) {
                            toast.error(
                              'Từ ngày và Đến ngày không được bỏ trống',
                              {
                                position: 'top-right',
                                autoClose: 5000,
                                hideProgressBar: false,
                      ...
                      >
                        <i className="fas fa-print"></i>&nbsp;Xuất dữ liệu hiện
                        tại
                      </Button>
                      <Button
                        color="info"
                        ...
                        onClick={() => {
                          ...
                          if (
                            ...
                            exportFile({
                              url: `${apiExportTransactionControl}`,
                              type: 'xlsx',
                              method: 'POST',
                              body: paramExport,
